...
//a)
function ePermitido(array){
	let podeEntrar = array.filter((pessoa)=>{
...
console.log(ePermitido(pessoas2))
//b)
function naoEPermitido(array){
	let naoPodeEntrar = array.filter((pessoa)=>{
		if((pessoa.altura < 1.5) || (pessoa.idade <=14) || (pessoa.idade >= 60)){
			return pessoa
		}
	})
